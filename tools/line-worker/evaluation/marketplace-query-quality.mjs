...
export const MARKETPLACE_QUERY_NEGATIVE_CASES = [
  ...
  {
    case_id: "ja-red-excluded-wallet",
    locale: "ja",
    category: "wallet",
    input: "赤以外の軽い財布",
    required_tokens: ["軽量", "財布"],
    forbidden_tokens: ["赤"],
    max_length: 48,
  },
  {
    case_id: "en-red-wallet",
    locale: "en",
    category: "wallet",
    input: "a compact red wallet",
    required_tokens: ["小型", "赤", "財布"],
    forbidden_tokens: [],
    max_length: 48,
  },
  {
    case_id: "en-red-excluded-wallet",
    locale: "en",
    category: "wallet",
    input: "a compact wallet, not red",
    required_tokens: ["小型", "財布"],
    forbidden_tokens: ["赤"],
    max_length: 48,
  },
  {
    case_id: "zh-beige-bag",
    locale: "zh",
    category: "bag",
    input: "想找轻量米色包包",
    required_tokens: ["軽量", "ベージュ", "バッグ"],
    forbidden_tokens: [],
    max_length: 48,
  },
  {
    case_id: "zh-red-excluded-bag",
    locale: "zh",
    category: "bag",
    input: "想找轻量包包，不要红色",
    required_tokens: ["軽量", "バッグ"],
    forbidden_tokens: ["赤"],
    max_length: 48,
  },
  {
    case_id: "ko-brown-bag",
    locale: "ko",
    category: "bag",
    input: "가벼운 갈색 가방을 찾아줘",
    required_tokens: ["軽量", "茶", "バッグ"],
    forbidden_tokens: [],
    max_length: 48,
  },
  {
    case_id: "ko-red-excluded-bag",
    locale: "ko",
    category: "bag",
    input: "빨간색 말고 가벼운 가방",
    required_tokens: ["軽量", "バッグ"],
