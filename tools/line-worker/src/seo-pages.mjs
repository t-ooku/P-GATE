...
const HUB_UPDATED_AT = '2026-08-23';
...
const pages = {
  ...
  // 2026-08-23: PR #61/#68 と意図が重複しない6本。#61と重なった4本は破棄済み。
  'find-items-for-a-korean-style-room': {
    ja: guide('ja', {
      title: '韓国っぽい部屋を作るアイテムの探し方',
      updatedAt: '2026-08-21',
      description: '「韓国っぽい部屋」という曖昧なイメージを、色・素材・形・光の条件に分解して、必要なアイテムを探す方法を解説します。',
      conclusion: '「韓国っぽい」は商品カテゴリではないため、そのまま検索しても候補が定まりません。イメージを「色のトーン」「素材の質感」「形の傾向」「照明の明るさと色」に分けてから、アイテムごとに探してください。全部をそろえる必要はなく、面積の大きいもの（カーテン、寝具、ラグ）から決めると部屋全体の印象が変わりやすくなります。',
      query: '白とベージュでまとめた部屋に合う、やわらかい光の間接照明',
      audience: [
        'イメージはあるが何を買えばよいか分からない人',
        '「韓国っぽい」を検索語にできない人',
        '少しずつ部屋の印象を変えたい人'
      ],
      tips: [
        'イメージを色のトーン・素材・形・照明の4つに分解する',
        '面積の大きいもの（カーテン・寝具・ラグ）から決める',
        'アイテムごとに検索し、まとめて探そうとしない'
      ],
      comparison: [
        ['色のトーンを決めたい', '基調にする色と、差し色を分けて入力', '同じ色名でも実物の見え方は異なる'],
        ['素材の質感を決めたい', '光沢の有無、厚み、肌ざわりを言葉にする', '手ざわりは画像で判断せず商品説明を確認'],
        ['照明を決めたい', '明るさと光の色、置き方を条件にする', '設置場所と電源の位置を先に確認']
      ],
      faq: [
        ['「韓国っぽい」で検索しても出てきません。', 'イメージを表す言葉は商品カテゴリではないため候補が定まりません。色、素材、形、照明などの条件に分けてアイテムごとに探してください。'],
        ['何から買えばよいですか？', '面積の大きいものから決めると印象が変わりやすくなります。カーテン、寝具、ラグなどを先に決め、小物は後から足す進め方が扱いやすいです。'],
        ['画面で見た色と実物の色は同じですか？', '表示環境や照明で色の見え方は変わります。販売ページのカラー名と商品説明を確認してください。'],
        ['サイズはどう確認しますか？', '設置する場所の幅・奥行き・高さを実測し、商品説明の寸法と照合してください。寸法が確認できない場合は設置できると断定しないでください。']
      ]
    })
  },
  'find-affordable-items-that-look-expensive': {
    ja: guide('ja', {
      title: 'プチプラで「高見え」する商品の探し方',
      updatedAt: '2026-08-21',
      description: '価格を抑えつつ見た目の印象がよい商品を、素材の見え方・仕上げ・形の条件から探す方法を解説します。',
      conclusion: '「高見え」は商品名では探せないため、見た目の印象を左右する条件に分解してください。過度な光沢を避ける、縫い目や継ぎ目の処理が整っている、装飾が少なく形がすっきりしている、といった条件は検索文に書けます。ただし見た目の印象は個人差があり、画像だけでは判断できません。素材表記と商品説明を販売ページで確認してください。',
      query: '装飾が少なくマットな質感の、シンプルなトートバッグ',
      audience: [
        '予算を抑えつつ見た目にこだわりたい人',
        '「安っぽく見える物」を避けたい人',
        '何を基準に選べばよいか分からない人'
      ...
      tips: [
        '「高見え」ではなく、素材の質感・仕上げ・形の条件で書く',
        '素材表記（合成皮革・綿・ポリエステル等）を商品説明で確認する',
        '画像の印象だけで判断せず、寸法と素材の記載を確認する'
      ],
      comparison: [
        ['素材で選ぶ', '光沢の有無、厚み、表面の質感を条件にする', '素材表記を販売ページで確認する'],
        ['仕上げで選ぶ', '縫い目、継ぎ目、金具の処理を条件にする', '画像の拡大表示と商品説明で確認する'],
        ['形で選ぶ', '装飾の少なさ、線の整い方を条件にする', '寸法を確認し実物の大きさを把握する']
      ],
      faq: [
        ['「高見え」で検索すれば見つかりますか？', '「高見え」は見た目の印象を表す言葉で、感じ方に個人差があります。素材の質感、仕上げ、形などの条件に置き換えて検索してください。'],
        ['安い商品でも品質は大丈夫ですか？', '価格と品質の関係は商品によって異なり、一律には判断できません。素材表記、商品説明、販売ページの記載を確認してください。'],
        ['画像で質感は分かりますか？', '撮影条件で見え方が変わるため、画像だけでは判断できません。素材表記と寸法の記載を必ず確認してください。'],
        ['同じ見た目でも価格差があるのはなぜですか？', '素材、製法、付属品、販売条件などが異なる場合があります。仕様をそろえたうえで比較してください。']
      ]
    })
  },
  'check-whether-a-viral-product-suits-you': {
    ja: guide('ja', {
      title: 'バズった商品が本当に自分に合うか確かめる方法',
      updatedAt: '2026-08-21',
      description: '話題になっている商品について、宣伝表示の有無や投稿時期の偏りを確認し、自分の使用条件と合うかを判断する方法を解説します。',
      conclusion: '話題になっていることと、自分に合うことは別です。まず宣伝や提供の表示があるかを確認し、投稿が特定の時期に集中していないかを見てください。そのうえで、長く使った人の感想と、自分と近い使用条件の感想を探します。話題性を理由に判断せず、自分の使う場所・頻度・目的に照らして確かめてください。',
      query: '話題になっている小型の掃除機を、ワンルームで週2回使う条件で確認したい',
      audience: [
        '話題の商品を買うか迷っている人',
        '宣伝と実際の評価を見分けたい人',
        '自分の使い方に合うか判断したい人'
      ...
      tips: [
        '宣伝・提供・案件の表示があるかを最初に確認する',
        '投稿が特定の時期に集中していないかを見る',
        '長く使った人の感想と、自分と近い使用条件の感想を探す'
      ],
      comparison: [
        ['宣伝表示がある', '提供や案件の表示を確認する', '感想の一部として扱い、他の情報と併せて見る'],
        ['投稿時期が偏っている', '公開から日が浅いか、時期が集中していないか確認', '短期間の評価だけで判断しない'],
        ['使用条件が書かれている', '自分と近い場所・頻度・目的の感想を探す', '条件が違う感想は参考範囲を分ける']
      ],
      faq: [
        ['話題の商品は品質がよいということですか？', '話題になっている理由は商品ごとに異なり、品質と直接結びつくとは限りません。自分の使用条件に合うかを個別に確認してください。'],
        ['宣伝かどうかはどこで分かりますか？', '提供・案件・広告などの表示が投稿側にあるかを確認してください。表示がある場合も、感想の一部として他の情報と併せて判断します。'],
        ['どのくらいの期間の感想を見ればよいですか？', '使い始めの感想と、しばらく使った後の感想では評価が変わることがあります。可能であれば使用期間が書かれた感想を探してください。'],
        ['在庫がなくて買えない場合はどうしますか？', '価格や在庫は変動します。検索条件を保存しておけば、後から同じ条件で探し直せます。']
      ]
    })
  },
  'find-alternatives-to-discontinued-cosmetics': {
    ja: guide('ja', {
      title: '廃盤になった化粧品と似た商品の探し方',
      updatedAt: '2026-08-21',
      description: '使っていた化粧品が見つからないときに、気に入っていた点を分解して近い条件の商品を探す方法を解説します。',
      conclusion: 'まず本当に販売終了かを確認してください。名称やパッケージの変更で見つからないだけの場合があり、メーカーの商品情報で現行品や後継品を確認できます。そのうえで「色」「質感」「仕上がり」「使用感」「容器の形」のうち、自分が気に入っていた点を分けて書き出し、近い条件で探してください。成分や肌への影響は商品名から判断できないため、販売ページの成分表示を確認してください。',
      query: '落ちにくくてツヤが出る、赤みの少ないベージュの口紅',
      audience: [
        '使っていた化粧品が見つからなくなった人',
        '同じような使い心地の商品を探したい人',
        '何を基準に代わりを選べばよいか分からない人'
      ],
      tips: [
        '販売終了と決める前に、メーカーの商品情報で現行品・後継品を確認する',
        '気に入っていた点を色・質感・仕上がり・使用感に分けて書き出す',
        '成分や肌への影響は商品名で判断せず、成分表示を確認する'
      ],
      comparison: [
        ['名称が変わっただけ', 'メーカーの商品情報で現行品名を確認', '同じ商品として仕様を照合する'],
        ['販売終了している', '気に入っていた点を分解して近い条件で探す', '完全一致は求めず優先する条件を決める'],
        ['判断がつかない', '旧名称と特徴の両方で探す', '確認できるまで代替品と決めつけない']
      ],
      faq: [
        ['販売終了かどうか分かりますか？', '検索結果だけでは断定できません。メーカーの公式な商品情報や販売ページで、販売状況と後継品の案内を確認してください。'],
        ['同じ使い心地の商品は見つかりますか？', '完全に同じものが見つかるとは限りません。色、質感、仕上がり、使用感のうち優先する条件を決めて探すと近い候補を見つけやすくなります。'],
        ['肌に合うかどうかは分かりますか？', '肌への影響は個人差があり、商品名からは判断できません。成分表示を確認し、不安がある場合は専門家に相談してください。'],
        ['以前と同じ色番を選べば同じ色ですか？', '色番の付け方はメーカーや商品ごとに異なります。同じ表記でも色が異なることがあるため、販売ページの商品説明を確認してください。']
      ]
    })
  },
  'find-the-name-of-an-old-household-tool': {
    ja: guide('ja', {
      title: '実家にあった「あの道具」の名前と入手方法',
      updatedAt: '2026-08-21',
      description: '実家や昔の家にあった名前の分からない生活道具を、用途と使い方から特定し、現行品や似た商品を探す方法を解説します。',
      conclusion: '古い生活道具は、見た目より「何をする道具か」から探すほうが早く近づきます。用途、動かし方、使っていた場所、材質の順に書き出してください。地域や家庭ごとに違う呼び方をしていた可能性もあるため、覚えている呼び名は正式名称と決めつけないでください。同じ物が現行品として無い場合も、同じ用途の商品が別の形で売られていることがあります。',
      query: '台所で使っていた、木の柄がついた金属製の押しつぶす道具',
      audience: [
        '実家にあった道具の名前が分からない人',
        '同じ物をもう一度手に入れたい人',
        '呼び名が正しいか自信がない人'
      ...
      tips: [
        '見た目より「何をする道具か」を先に書く',
        '動かし方（押す・回す・挟む・すくう）を言葉にする',
        '覚えている呼び名は正式名称と決めつけない'
      ],
      comparison: [
        ['用途を覚えている', '何をする道具かと使う場所を入力', '同じ用途の現行品から候補を確認'],
        ['形と材質を覚えている', '材質、大きさ、持ち手の形を書き出す', '似た形の候補を用途で絞り込む'],
        ['呼び名しか出てこない', '呼び名と用途を組み合わせて入力', '呼び名が通称の可能性を前提に確認']
      ],
      faq: [
        ['正式名称が分からなくても探せますか？', 'はい。何をする道具か、どう動かすか、どこで使っていたかを文章で入力すれば、条件を整理して検索を始められます。'],
        ['家で使っていた呼び方で検索してよいですか？', '入力して構いませんが、家庭や地域ごとの通称のことがあります。呼び名と一緒に用途も書くと候補が見つかりやすくなります。'],
        ['同じ物が売っていない場合はどうしますか？', '同じ用途の商品が別の形で販売されていることがあります。用途を軸に探し、仕様を販売ページで確認してください。'],
        ['中古品を買っても大丈夫ですか？', '商品の状態や付属品は出品ごとに異なります。販売ページで状態表示、販売者、保証の有無を確認してください。']
      ]
    })
  },
  'find-the-name-of-a-kitchen-tool': {
    ja: guide('ja', {
      title: '名前の分からない調理器具の探し方',
      updatedAt: '2026-08-21',
      description: '名前が分からない調理器具を、何を作る道具か・どんな動作をするか・対応する熱源から探す方法を解説します。',
      conclusion: '調理器具は「何をする道具か」を動作で表すと絞り込みやすくなります。切る、混ぜる、こす、はさむ、計るなどの動作と、扱う食材を組み合わせてください。似た形でも用途が違う道具があるため、候補が出たら材質と対応する熱源、食洗機に対応するかを商品説明で確認します。',
      query: 'ゆで卵をきれいに輪切りにできる、ワイヤーが張られた道具',
      audience: [
        '調理器具の名前が分からない人',
        '見たことはあるが用途が曖昧な人',
        '似た道具の違いを知りたい人'
      ...
      tips: [
        '動作（切る・混ぜる・こす・はさむ・計る）で書く',
        '扱う食材と、作りたい仕上がりを添える',
        '候補が出たら材質・対応熱源・食洗機対応を商品説明で確認する'
      ],
      comparison: [
        ['動作を覚えている', '動作と食材を組み合わせて入力', '同じ動作の道具から候補を確認'],
        ['形だけ覚えている', '大きさ、持ち手、可動部の有無を書き出す', '似た形でも用途が違う道具に注意'],
        ['使う場面を覚えている', '調理の工程と仕上がりを書く', '工程が同じ別の道具も候補に含める']
      ],
      faq: [
        ['名前が分からなくても調理器具を探せますか？', 'はい。何をする道具か、どんな動作をするか、どの食材に使うかを文章で入力すれば、条件を整理して検索を始められます。'],
        ['似た形の道具はどう見分けますか？', '用途と可動部の有無、刃や網の形で異なります。商品説明の用途表示を確認し、形だけで同じ道具と判断しないでください。'],
        ['自宅の熱源で使えるか分かりますか？', '対応する熱源は商品ごとに異なります。販売ページの対応熱源の記載を確認してください。'],
        ['食洗機で洗えますか？', '対応の可否は商品ごとに異なります。商品説明の記載を確認し、記載がない場合は対応していると断定しないでください。']
      ]
    })
  }
};
...
,
    'find-items-for-a-korean-style-room': {
      intent: 'find_items_for_a_style_based_room', cluster: 'trend-discovery', articleType: 'shopping-guide',
      headings: ['決めたい要素', '条件への分解', '購入前の確認'],
      steps: [['イメージを4つに割る', '色のトーン、素材の質感、形の傾向、照明の条件に分けます。'], ['面積の大きい物から', 'カーテン、寝具、ラグなど印象を左右する物から順に決めます。'], ['寸法と色を確認', '設置場所を実測し、商品説明の寸法とカラー名を販売ページで確認します。']]
    },
    'find-affordable-items-that-look-expensive': {
      intent: 'find_affordable_items_that_look_expensive', cluster: 'trend-discovery', articleType: 'shopping-guide',
      headings: ['選ぶ観点', '条件の書き方', '確認する記載'],
      steps: [['印象を条件に変える', '「高見え」を素材の質感、仕上げ、形の条件に置き換えます。'], ['素材表記を読む', '合成皮革・綿・ポリエステルなど、素材の記載を商品説明で確認します。'], ['画像に頼らない', '撮影条件で見え方が変わるため、寸法と素材の記載で最終確認します。']]
    },
    'check-whether-a-viral-product-suits-you': {
      intent: 'evaluate_viral_products', cluster: 'reviews-and-trust', articleType: 'review-guide',
      headings: ['情報の状態', '確認する内容', '判断での扱い'],
      steps: [['宣伝表示を確認', '提供・案件・広告の表示が投稿側にあるかを最初に確認します。'], ['時期の偏りを見る', '投稿が特定の時期に集中していないか、公開からの期間を確認します。'], ['自分の条件で照合', '使う場所・頻度・目的が自分と近い感想を探して判断します。']]
    },
    'find-alternatives-to-discontinued-cosmetics': {
      intent: 'find_alternatives_to_discontinued_cosmetics', cluster: 'legacy-discovery', articleType: 'how-to',
      headings: ['商品の状態', '進め方', '購入前の確認'],
      steps: [['販売状況を確かめる', '名称やパッケージの変更ではないか、メーカーの商品情報で確認します。'], ['好みを分解する', '色、質感、仕上がり、使用感のうち気に入っていた点を書き出します。'], ['成分表示を見る', '肌への影響は商品名で判断せず、販売ページの成分表示を確認します。']]
    },
    'find-the-name-of-an-old-household-tool': {
      intent: 'identify_old_household_tool', cluster: 'legacy-discovery', articleType: 'how-to',
      headings: ['覚えている内容', '書き出す順番', '入手方法の確認'],
      steps: [['用途を先に書く', '見た目より「何をする道具か」と使っていた場所を書きます。'], ['動かし方を足す', '押す、回す、挟む、すくうなど、どう動かしていたかを言葉にします。'], ['現行品を確認する', '同じ物が無くても、同じ用途の商品が別の形で売られていないか確認します。']]
    },
    'find-the-name-of-a-kitchen-tool': {
      intent: 'identify_kitchen_tool', cluster: 'ai-discovery', articleType: 'how-to',
      headings: ['覚えている内容', '絞り込み方', '購入前の確認'],
      steps: [['動作で表す', '切る、混ぜる、こす、はさむ、計るなど、動作で用途を表します。'], ['食材を添える', '扱う食材と作りたい仕上がりを組み合わせて条件にします。'], ['対応条件を確認', '材質、対応する熱源、食洗機に対応するかを商品説明で確認します。']]
    }
  },
  en: {
    'american-products-in-japan': {
...
const guideHubGroups = [
  ...
  },
  {
    ...
    slugs: [
      ...
      'shopping-guide-for-students-on-a-budget'
    ,
      'find-items-for-a-korean-style-room', 'find-affordable-items-that-look-expensive'
    ]
  },
  ...
  {
    id: 'legacy',
    title: '昔の商品・名前が分からない道具を探す',
    description: '販売終了かもしれない商品や、実家にあった名前の分からない道具を、用途と特徴からたどるガイドです。',
    slugs: [
      'find-discontinued-or-renamed-products', 'find-alternatives-to-discontinued-cosmetics',
      'find-the-name-of-an-old-household-tool', 'find-the-name-of-a-kitchen-tool'
    ]
  },
  {
    id: 'identify',
