...
const THEMES = Object.freeze([
  { id: 'cross_market_phone_case', pillar: 'CROSS_MARKET', format: 'CAROUSEL', memory: 'TikTokで見た、光るスマホケース', refined: 'TikTokで見た光るiPhoneケース', hook: 'その「どこで売ってる？」を4モールで一気に探そう。' },
  ...
  { id: 'qoo10_price_compare', pillar: 'CROSS_MARKET', format: 'CAROUSEL', marketplace_focus: 'QOO10_JP', memory: '韓国で人気の透明ケースのイヤホン', refined: '韓国風 透明ケース ワイヤレスイヤホン', hook: 'Qoo10だけで決める前に、4モールで買える場所を見比べよう。' },
...
function reelScript(theme) {
  ...
  return {
    ...
    scenes: [
      ...
      `5-9秒：候補とAmazon・楽天市場・Qoo10・SHEINの横断結果をテンポよく表示`,
