...
const copy = {
  JA: { hero:'今日は、|何が欲しい？', userView:'ユーザー体験', sellerView:'セラー体験', languageLabel:'表示言語', title:'商品名が分からなくても、うまく説明できなくても大丈夫。\n見た目、見た場所、使い方。覚えていることから話してください。', titleSummary:'使い方を見る', placeholder:'例：インスタで見た、ピンクで小さいカメラみたいなもの', consent:'質問の処理と匿名の利用状況計測に同意します。質問本文はサーバーログへ保存しません。', submit:'一緒に見つける', results:'ホシルからの提案', loading:'候補を探しています…', buy:'販売ページで確認', total:'合計', shipping:'送料', delivery:'配送目安', days:'日', error:'現在検索できません。入力内容または通信状態を確認して、もう一度お試しください。', examples:['TikTokで見た光るスマホケース','推し活で使える小さな写真プリンター','韓国っぽい透明のワイヤレスイヤホン'], wish:'AIウォッチを開始', wishSaved:'AIウォッチ中', emptyWish:'AIウォッチ中の商品はまだありません。', filteredEmptyWish:'一致するAIウォッチはありません。', wishTitle:'AIウォッチで、見つけたら教えてもらう。', wishDescription:'お気に入りではありません。\nAIがこの商品を継続監視し、条件を満たしたら知らせる機能です。', watchTitle:'AIウォッチ', watchDescription:'AIがこの商品の価格・在庫・クーポンを24時間監視します。', watchLabels:['値下げ','クーポン','再入荷','販売開始'], sellerTitle:'欲しいを、|売上機会に。', sellerDescription:'米国Amazon仕入れの並行輸入商品を、在日外国人と米国商品を探す日本人へ届けます。' },
  EN: { hero:'What are you |looking for today?', userView:'Shopper', sellerView:'Seller', languageLabel:'Language', title:'You do not need to know the product name.\nAppearance, where you saw it, and how it is used. Tell us whatever you remember.', titleSummary:'How it works', placeholder:'Example: a small US car part whose name I do not know in Japanese', consent:'I consent to processing my question and anonymous usage measurement. The raw question is not stored in server logs.', submit:'Find it with me', results:'Suggestions from HOSHILU', loading:'Looking for matches…', buy:'View product page', total:'Total', shipping:'Shipping', delivery:'Delivery estimate', days:'days', error:'Search is unavailable. Check your input or connection and try again.', examples:['a US-exclusive collectible figure','a small US appliance that works in Japan','a small car part whose name I forgot'], wish:'Start AI Watch', wishSaved:'AI Watch on', emptyWish:'Nothing is being watched by AI yet.', filteredEmptyWish:'No AI Watch items match your search.', wishTitle:'Let AI Watch tell you the moment it is found.', wishDescription:'This is not a favorites list.\nAI keeps monitoring this item and notifies you when your conditions are met.', watchTitle:'AI Watch', watchDescription:'AI monitors this product’s price, stock, and coupons around the clock.', watchLabels:['Price drop','Coupon','Restock','Available'], sellerTitle:'Turn demand into |sales opportunities.', sellerDescription:'Connect US Amazon imports with international residents in Japan and Japanese shoppers seeking American products.' },
  ZH: { hero:'今天，您想找|什么？', userView:'买家体验', sellerView:'卖家体验', languageLabel:'显示语言', title:'不知道商品名称也没关系。\n外观、看到它的地方、用途。请告诉我们您记得的内容。', titleSummary:'查看使用方法', placeholder:'例如：不知道日语名称的美国小型汽车零件', consent:'我同意处理问题并进行匿名使用情况统计。问题原文不会保存到服务器日志。', submit:'一起寻找', results:'HOSHILU 的推荐', loading:'正在寻找候选商品…', buy:'前往销售页面确认', total:'合计', shipping:'运费', delivery:'配送预计', days:'天', error:'目前无法搜索。请确认输入或网络后重试。', examples:['美国限定收藏手办','可在日本使用的美国小家电','忘记名称的小型汽车零件'], wish:'开启AI监控', wishSaved:'AI监控中', emptyWish:'还没有AI监控的商品。', filteredEmptyWish:'没有符合搜索条件的AI监控项目。', wishTitle:'开启AI监控，找到时立即通知您。', wishDescription:'这不是收藏夹。\nAI会持续监控该商品，满足条件时通知您。', watchTitle:'AI监控', watchDescription:'AI将24小时监控该商品的价格、库存和优惠券。', watchLabels:['降价','优惠券','补货','开售'], sellerTitle:'把需求变成|销售机会。', sellerDescription:'将美国亚马逊进口商品带给在日外国人及寻找美国商品的日本消费者。' },
  KO: { hero:'오늘은 무엇을|찾고 있나요?', userView:'구매자', sellerView:'판매자', languageLabel:'표시 언어', title:'상품명을 몰라도 괜찮습니다.\n생김새, 본 장소, 사용법. 기억나는 것을 말해 주세요.', titleSummary:'사용법 보기', placeholder:'예: 일본어 이름을 모르는 미국산 소형 자동차 부품', consent:'질문 처리와 익명 이용 통계에 동의합니다. 질문 원문은 서버 로그에 저장하지 않습니다.', submit:'함께 찾기', results:'HOSHILU 추천', loading:'후보를 찾고 있습니다…', buy:'판매 페이지에서 확인', total:'합계', shipping:'배송비', delivery:'배송 예상', days:'일', error:'현재 검색할 수 없습니다. 입력이나 연결 상태를 확인하고 다시 시도해 주세요.', examples:['미국 한정 피규어','일본에서 쓸 수 있는 미국 소형 가전','이름을 잊은 작은 자동차 부품'], wish:'AI 워치 시작', wishSaved:'AI 워치 중', emptyWish:'AI 워치 중인 상품이 아직 없습니다.', filteredEmptyWish:'검색과 일치하는 AI 워치가 없습니다.', wishTitle:'AI 워치로 찾으면 바로 알려드립니다.', wishDescription:'즐겨찾기가 아닙니다.\nAI가 이 상품을 계속 지켜보다가 조건을 충족하면 알려주는 기능입니다.', watchTitle:'AI 워치', watchDescription:'AI가 이 상품의 가격·재고·쿠폰을 24시간 지켜봅니다.', watchLabels:['가격 인하','쿠폰','재입고','판매 시작'], sellerTitle:'원하는 마음을|판매 기회로.', sellerDescription:'미국 Amazon 병행수입 상품을 일본 거주 외국인과 미국 상품을 찾는 일본인에게 연결합니다.' }
};

const actionCopy = {
  JA:{deleteWishAria:'このAIウォッチを削除',deleteAllWishes:'すべて削除',deleteAllConfirm:'AIウォッチをすべて削除しますか？この操作は取り消せません。',clear:'クリア',searchAgain:'もう一度検索',updateWish:'変更を保存',updated:'変更を保存しました',deleteWish:'削除',deleteConfirm:'このAIウォッチを解除しますか？',insightTitle:'AIウォッチ中の商品を振り返る。',insightTemplate:'AIウォッチ {count}件、選択中の通知条件 {alerts}件。',saveWish:'この検索をAIウォッチ',wishSaved:'AIウォッチ中',saveWatch:'この条件でAIウォッチ',watchSaved:'AIウォッチを保存しました',bundleNote:'AIがこの商品の価格・在庫・クーポンを24時間監視します。',discoveryTitle:'名前が分からなくても、\n記憶から探せる。',discoveryBody:'見た目、見た場所、使い方。覚えていることから話してください。',discoveryExample:'SNSで見た、ピンクの小さいカメラみたいなもの',journey:['検索する前に、|ホシルに話す。','曖昧な「欲しい」を、|見つかる検索へ変換します。','思い出せるまま話す','名前が分からなくても、見た目・用途・見た場所だけで大丈夫。','検索条件を精密化','ホシルが商品カテゴリや特徴を整理し、探せる言葉へ変換。','購入先まで案内','商品ページへ直接リンク。主要5モール、ファッション含めて最大10モールで探せます。'],copyKeywords:'検索ワードをコピー',copiedKeywords:'コピーしました'},
  EN:{deleteWishAria:'Delete this AI Watch item',deleteAllWishes:'Delete all',deleteAllConfirm:'Delete every AI Watch item? This cannot be undone.',clear:'Clear',searchAgain:'Search again',updateWish:'Save changes',updated:'Changes saved',deleteWish:'Delete',deleteConfirm:'Turn off AI Watch for this item?',insightTitle:'Review what AI Watch is tracking.',insightTemplate:'{count} AI Watch items and {alerts} selected alert settings.',saveWish:'Put this search on AI Watch',wishSaved:'AI Watch on',saveWatch:'Save these AI Watch settings',watchSaved:'AI Watch settings saved',bundleNote:'AI monitors this product’s price, stock, and coupons around the clock.',discoveryTitle:'Find it from what you remember—\neven without the name.',discoveryBody:'Appearance, where you saw it, and how it is used. Tell us whatever you remember.',discoveryExample:'A small pink camera-like thing I saw on social media',journey:['Talk to HOSHILU before you search.','Turn a vague want into a search that finds it.','Describe what you remember','A look, a use, or where you saw it is enough.','Sharpen the search','HOSHILU turns clues into product categories and precise terms.','Continue to purchase','Link directly to product pages. Search five core marketplaces, or up to ten including fashion.'],copyKeywords:'Copy search terms',copiedKeywords:'Copied'},
  ZH:{deleteWishAria:'删除此AI监控',deleteAllWishes:'全部删除',deleteAllConfirm:'要删除所有AI监控吗？此操作无法撤销。',clear:'清空',searchAgain:'再次搜索',updateWish:'保存更改',updated:'更改已保存',deleteWish:'删除',deleteConfirm:'要关闭此商品的AI监控吗？',insightTitle:'回顾AI监控中的商品。',insightTemplate:'AI监控 {count} 项，已选择 {alerts} 个提醒条件。',saveWish:'将此搜索加入AI监控',wishSaved:'AI监控中',saveWatch:'保存AI监控条件',watchSaved:'AI监控条件已保存',bundleNote:'AI将24小时监控该商品的价格、库存和优惠券。',discoveryTitle:'不知道名字，\n也能从记忆中寻找。',discoveryBody:'外观、看到它的地方、用途。请告诉我们您记得的内容。',discoveryExample:'在社交媒体上看到的粉色小相机一样的东西',journey:['搜索之前，先告诉 HOSHILU。','把模糊的“想要”变成更容易找到的搜索。','说出记得的线索','不知道名称也没关系，外观、用途或看到的地方即可。','优化搜索条件','HOSHILU 将线索整理为商品类别和准确关键词。','引导至购买页面','直接链接商品页面。覆盖五个主要商城，包含时尚商城时最多十个。'],copyKeywords:'复制搜索词',copiedKeywords:'已复制'},
  KO:{deleteWishAria:'이 AI 워치 삭제',deleteAllWishes:'전체 삭제',deleteAllConfirm:'AI 워치를 모두 삭제할까요? 되돌릴 수 없습니다.',clear:'전체 삭제',searchAgain:'다시 검색',updateWish:'변경 저장',updated:'변경을 저장했습니다',deleteWish:'삭제',deleteConfirm:'이 상품의 AI 워치를 해제할까요?',insightTitle:'AI 워치 중인 상품을 돌아보기.',insightTemplate:'AI 워치 {count}건, 선택한 알림 조건 {alerts}건.',saveWish:'이 검색을 AI 워치에 등록',wishSaved:'AI 워치 중',saveWatch:'이 조건으로 AI 워치',watchSaved:'AI 워치 설정을 저장했습니다',bundleNote:'AI가 이 상품의 가격·재고·쿠폰을 24시간 지켜봅니다.',discoveryTitle:'이름을 몰라도,\n기억에서 찾을 수 있어요.',discoveryBody:'생김새, 본 장소, 사용법. 기억나는 것을 말해 주세요.',discoveryExample:'SNS에서 본 분홍색 작은 카메라 같은 것',journey:['검색하기 전에 HOSHILU에게 말하세요.','막연한 원하는 것을 찾을 수 있는 검색으로 바꿉니다.','기억나는 대로 말하기','이름을 몰라도 생김새, 용도, 본 장소만으로 충분합니다.','검색 조건 정밀화','HOSHILU가 단서를 상품 분류와 정확한 검색어로 바꿉니다.','구매처까지 안내','상품 페이지로 바로 연결합니다. 주요 5개 쇼핑몰과 패션을 포함해 최대 10개 쇼핑몰에서 찾을 수 있습니다.'],copyKeywords:'검색어 복사',copiedKeywords:'복사했습니다'}
};
...
const shareCopy={
  JA:{title:'HOSHILUで探した',button:'SNSでシェア',copy:'リンクをコピー',gmail:'Gmailで送る',include:'検索内容も投稿に含める',privacy:'初期状態では検索内容を共有しません。',tag:'#ホシルで見つけた',prefix:'HOSHILUで探しました：',copied:'投稿文とHOSHILUリンクをコピーしました'},
  EN:{title:'Found with HOSHILU',button:'Share',copy:'Copy link',gmail:'Send with Gmail',include:'Include my search in the post',privacy:'Your search is not shared by default.',tag:'#FoundWithHOSHILU',prefix:'I searched with HOSHILU: ',copied:'Post text and HOSHILU link copied'},
  ZH:{title:'用 HOSHILU 找到',button:'分享到社交平台',copy:'复制链接',gmail:'用 Gmail 发送',include:'在帖子中包含搜索内容',privacy:'默认不会分享您的搜索内容。',tag:'#用HOSHILU找到',prefix:'我用 HOSHILU 搜索了：',copied:'已复制文字和 HOSHILU 链接'},
  KO:{title:'HOSHILU로 찾았어요',button:'SNS 공유',copy:'링크 복사',gmail:'Gmail로 보내기',include:'검색 내용도 게시물에 포함',privacy:'기본 상태에서는 검색 내용을 공유하지 않습니다.',tag:'#HOSHILU로찾음',prefix:'HOSHILU로 검색했어요: ',copied:'게시 문구와 HOSHILU 링크를 복사했습니다'}
};

const $ = (selector) => document.querySelector(selector);
const elements = { form:$('#knowledgeForm'), query:$('#query'), consent:$('#consent'), language:$('#languageSelect'), languageLabel:$('#languageLabel'), heroTitle:$('#heroTitle'), heroEyebrow:$('#heroEyebrow'), searchStep:$('#searchStep'), searchTitle:$('#searchTitle'), searchTitleSummary:$('#searchTitleSummary'), consentText:$('#consentText'), submitText:$('#submitText'), submit:$('#submitButton'), status:$('#status'), quick:$('#quickQueries'), results:$('#resultsSection'), resultsTitle:$('#resultsTitle'), message:$('#resultMessage'), cards:$('#resultCards'), turnstile:$('#turnstileContainer'), install:$('#installButton'), wishList:$('#wishList'), wishTitle:$('#wishTitle'), wishDescription:$('#wishDescription'), wishFilter:$('#wishFilter'), clear:$('#clearQuery'), memberLink:$('#memberLink'), memberLogout:$('#memberLogout'), goSearch:$('#goSearch'), goWish:$('#goWish'), insightTitle:$('#insightTitle'), insightSummary:$('#insightSummary'), discoveryTitle:$('#discoveryTitle'), discoveryBody:$('#discoveryBody'), discoveryExample:$('#discoveryExample'), journey:[$('#journeyTitle'),$('#journeyLead'),$('#journeyStep1Title'),$('#journeyStep1Body'),$('#journeyStep2Title'),$('#journeyStep2Body'),$('#journeyStep3Title'),$('#journeyStep3Body')] };
...
function marketplaceLabel(value){ return {AMAZON_JP:'Amazon',RAKUTEN_JP:'楽天市場',QOO10_JP:'Qoo10',SHEIN_JP:'SHEIN',ZOZOTOWN_JP:'ZOZOTOWN',SHOPLIST_JP:'SHOPLIST',MUSINSA_JP:'MUSINSA',BUYMA_JP:'BUYMA',SNKRDUNK_JP:'SNKRDUNK',YAHOO_JP:'Yahoo!ショッピング'}[value]||String(value||''); }
...
function personalizedQuickExamples(language=elements.language.value||'JA'){if(!memberSession)return[];const history=getSearchHistory();if(!history.length)return[];const picked=[];const seenThemes=new Set();for(const query of history){const clean=String(query).split(' / ')[0].trim().slice(0,80);if(!clean)continue;const idea=discoveryIdeas.find(item=>item.match.test(clean));const theme=idea?.match.source||`other:${clean}`;if(seenThemes.has(theme))continue;seenThemes.add(theme);picked.push(clean);if(picked.length===3)break;}return picked;}
function renderQuickExamples(language=elements.language.value||'JA'){elements.quick.replaceChildren();if(!memberSession){const link=document.createElement('a');link.className='chip member-example-cta';link.href='/login.html';link.textContent={JA:'無料会員登録で、あなた向けの検索例を表示',EN:'Sign up free for personalized search ideas',ZH:'免费注册后显示适合您的搜索建议',KO:'무료 가입 후 맞춤 검색 예시 보기'}[language]||'無料会員登録で、あなた向けの検索例を表示';elements.quick.append(link);return;}const examples=personalizedQuickExamples(language);if(!examples.length){elements.quick.append(textElement('p','quick-query-note',{JA:'検索すると、履歴からあなた向けの次の検索例を3つ提案します。',EN:'Search once to get three personalized ideas from your history.',ZH:'搜索一次后，将根据历史记录推荐三个搜索建议。',KO:'한 번 검색하면 기록을 바탕으로 맞춤 검색 예시 3개를 추천합니다.'}[language]));return;}examples.forEach(example=>{const button=document.createElement('button');button.type='button';button.className='chip';button.textContent=example;button.addEventListener('click',()=>{elements.query.value=example;elements.clear.classList.remove('hidden');focusSearch();});elements.quick.append(button);});}
...
function storeWatchPreference(query,options,asin='',frequency=watchFrequencyFor(query)){const current=getWatchPreferences();const item={asin:String(asin||''),query:String(query||'').trim(),options:options.map(Boolean),frequency,updatedAt:new Date().toISOString()};localStorage.setItem('hoshilu_watch_preferences',JSON.stringify([item,...current.filter(saved=>saved.query!==item.query)].slice(0,100)));}
...
function payloadFor(query,options,frequency=watchFrequencyFor(query)){return{query,language:elements.language.value,watch_sale:Boolean(options[0]),watch_price:Boolean(options[1]),watch_coupon:Boolean(options[2]),watch_restock:Boolean(options[3]),watch_frequency:frequency};}
function saveWish(query,options=watchOptionsFor(String(query||'').trim())){const value=String(query||'').trim();if(!value)return false;setWishes([value,...getWishes().filter(item=>item!==value)]);storeWatchPreference(value,options);renderWishes();if(memberSession)persistMemberWish(value,options);return true;}
async function persistMemberWish(query,options=watchOptionsFor(query)){try{const response=await fetch('/api/member/wishes',{method:'POST',headers:{'content-type':'application/json'},body:JSON.stringify(payloadFor(query,options))});if(response.ok){const record=(await response.json()).wish;memberWishRecords=[record,...memberWishRecords.filter(item=>item.wish_id!==record.wish_id)];return record;}}catch{}return null;}
...
async function syncMemberWishes(){try{const sessionResponse=await fetch('/api/member/session',{cache:'no-store'});if(!sessionResponse.ok)return;memberSession=(await sessionResponse.json()).member;renderMemberState();const local=getWishes();for(const query of local)await persistMemberWish(query,watchOptionsFor(query));const response=await fetch('/api/member/wishes',{cache:'no-store'});if(!response.ok)return;memberWishRecords=(await response.json()).wishes||[];memberWishRecords.forEach(item=>storeWatchPreference(item.query_text,[item.watch_sale,item.watch_price,item.watch_coupon,item.watch_restock].map(Boolean),'',item.watch_frequency));const merged=[...memberWishRecords.map(item=>item.query_text),...local].filter((value,index,array)=>value&&array.indexOf(value)===index);setWishes(merged);renderWishes();}catch{}}
function renderInsight(){const actions=actionCopy[elements.language.value]||actionCopy.JA;const wishes=getWishes();const alerts=wishes.reduce((total,query)=>total+watchOptionsFor(query).filter(Boolean).length,0);elements.insightTitle.textContent=actions.insightTitle;elements.insightSummary.textContent=actions.insightTemplate.replace('{count}',String(wishes.length)).replace('{alerts}',String(alerts));}
...
function wishItem(value,t,actions){const details=document.createElement('details');details.className='wish-item';const summary=document.createElement('summary');summary.append(textElement('span','wish-item-label',localizedWishLabel(value,elements.language.value)),wishRowDeleteButton(value,actions));const editor=document.createElement('div');editor.className='wish-editor';const optionGrid=document.createElement('div');optionGrid.className='watch-options';const inputs=t.watchLabels.map((label,index)=>{const input=document.createElement('input');input.type='checkbox';input.checked=watchOptionsFor(value)[index];const row=document.createElement('label');row.append(input,document.createTextNode(` ${label}`));optionGrid.append(row);return input;});const frequency=document.createElement('select');frequency.setAttribute('aria-label','通知頻度');[['INSTANT','すぐに通知'],['DAILY','1日1回'],['WEEKLY','週1回'],['MUTED','通知を停止']].forEach(([key,label])=>{const option=document.createElement('option');option.value=key;option.textContent=label;frequency.append(option);});frequency.value=watchFrequencyFor(value);const controls=document.createElement('div');controls.className='wish-controls';const search=document.createElement('button');search.type='button';search.textContent=actions.searchAgain;search.addEventListener('click',()=>{elements.query.value=value;elements.clear.classList.remove('hidden');focusSearch();});const update=document.createElement('button');update.type='button';update.textContent=actions.updateWish;const remove=document.createElement('button');remove.type='button';remove.className='danger';remove.textContent=actions.deleteWish;const status=textElement('p','wish-edit-status','');update.addEventListener('click',async()=>{const options=inputs.map(input=>input.checked);storeWatchPreference(value,options,'',frequency.value);setWishes([value,...getWishes().filter(item=>item!==value)]);const record=recordFor(value);if(record){await fetch(`/api/member/wishes/${record.wish_id}`,{method:'PATCH',headers:{'content-type':'application/json'},body:JSON.stringify(payloadFor(value,options,frequency.value))});memberWishRecords=[{...record,watch_frequency:frequency.value,updated_at:new Date().toISOString()},...memberWishRecords.filter(item=>item.wish_id!==record.wish_id)];}else if(memberSession)await persistMemberWish(value,options);renderWishes();});remove.addEventListener('click',async()=>{if(!confirm(actions.deleteConfirm))return;await deleteWish(value);renderWishes();});controls.append(search,update,remove);editor.append(optionGrid,frequency,controls,status);details.append(summary,editor);return details;}
...
function createWatchOptions(t){
  ...
  bell.type='button';bell.className='watch-bell';bell.setAttribute('aria-label',t.watchTitle);bell.textContent='🔔';
  ...
  save.addEventListener('click',()=>{
    if(saveWish(elements.query.value,inputs.map((input)=>input.checked))){
      status.textContent=t.wishSaved;
      bell.classList.add('watching');
      setTimeout(()=>dialog.close(),700);
    }
  });
  panel.append(options,save,status);
  dialog.append(panel);
...
const refinementCopy={JA:{title:'まだ見つからない場合',body:'覚えている色・大きさ・電源・使う場所などを検索文に追加すると、候補をさらに絞れます。',button:'条件を追加して再検索'},EN:{title:'Not seeing it yet?',body:'Add any remembered color, size, power source, or place of use to narrow the matches.',button:'Add details and search again'},ZH:{title:'还没找到吗？',body:'补充记得的颜色、大小、电源或使用场所，可以进一步缩小候选范围。',button:'补充条件并再次搜索'},KO:{title:'아직 찾지 못했나요?',body:'기억나는 색상, 크기, 전원 방식, 사용 장소를 추가하면 후보를 더 좁힐 수 있습니다.',button:'조건을 추가해 다시 검색'}};
function refinementCard(){const t=refinementCopy[elements.language.value]||refinementCopy.JA;const card=document.createElement('article');card.className='refinement-card';const copyWrap=document.createElement('div');copyWrap.append(textElement('strong','',t.title),textElement('p','',t.body));const button=document.createElement('button');button.type='button';button.className='secondary';button.textContent=t.button;button.addEventListener('click',()=>{focusSearch();setTimeout(()=>{const end=elements.query.value.length;elements.query.setSelectionRange(end,end);},380);});card.append(copyWrap,button);return card;}
...
if(item.channel)link.dataset.channel=String(item.channel);link.href=item.url;link.target='_blank';link.rel='noopener noreferrer';
...
function emergencyMarketplaceSearchLinks(query){const keywords=String(query||'').trim();if(!keywords)return[];const mallKeywords=marketplace=>encodeURIComponent(buildMarketplaceSearchKeywords(keywords,marketplace)||keywords);return[{marketplace:'AMAZON_JP',label:'Amazonで探す',url:`https://www.amazon.co.jp/s?k=${mallKeywords('AMAZON_JP')}&tag=hoshilu-22`},{marketplace:'RAKUTEN_JP',label:'楽天市場で探す',url:`https://search.rakuten.co.jp/search/mall/${mallKeywords('RAKUTEN_JP')}/`},{marketplace:'YAHOO_JP',label:'Yahoo!ショッピングで探す',url:`https://shopping.yahoo.co.jp/search?p=${mallKeywords('YAHOO_JP')}`},{marketplace:'QOO10_JP',label:'Qoo10で探す',url:`https://www.qoo10.jp/s/?keyword=${mallKeywords('QOO10_JP')}`},{marketplace:'SHEIN_JP',label:'SHEINで探す',url:`https://jp.shein.com/pdsearch/${mallKeywords('SHEIN_JP')}/`}];}
function emergencyMarketplaceFallback(query){const messages={JA:'商品候補を取得できなかったため、5つのモールで同じ条件を探せるリンクを表示しています。',EN:'Product suggestions are temporarily unavailable, so you can continue the same search across five marketplaces.',ZH:'暂时无法获取商品候选，因此显示可在五个商城继续搜索相同条件的链接。',KO:'상품 후보를 가져오지 못해 같은 조건으로 5개 쇼핑몰에서 계속 찾을 수 있는 링크를 표시합니다.'};return{message:messages[elements.language.value]||messages.JA,candidates:[],search_keywords:String(query||'').trim(),marketplace_search_links:emergencyMarketplaceSearchLinks(query)};}
const aiIntentLabels={JA:{category:'カテゴリ',features:'特徴',confidence:'理解度',reason:'理由',keywords:'検索ワード',brand:'ブランド',candidates:'HOSHILU AIが見つけた商品候補'},EN:{category:'Category',features:'Features',confidence:'Match confidence',reason:'Why',keywords:'Search terms',brand:'Brand',candidates:'Product candidates from HOSHILU AI'},ZH:{category:'类别',features:'特征',confidence:'理解度',reason:'理由',keywords:'搜索词',brand:'品牌',candidates:'HOSHILU AI找到的商品候选'},KO:{category:'카테고리',features:'특징',confidence:'이해도',reason:'이유',keywords:'검색어',brand:'브랜드',candidates:'HOSHILU AI가 찾은 상품 후보'}};
...
const relatedKeywordCopy={
  JA:{ai:'AI連想キーワード（タップで検索条件に追加）',result:'検索結果からの関連キーワード（タップで検索条件に追加）'},
  EN:{ai:'AI related keywords (tap to add to your search)',result:'Related keywords from these results (tap to add to your search)'},
  ZH:{ai:'AI联想关键词（点击加入搜索条件）',result:'来自搜索结果的相关关键词（点击加入搜索条件）'},
  KO:{ai:'AI 연상 키워드 (탭하여 검색 조건에 추가)',result:'검색 결과의 관련 키워드 (탭하여 검색 조건에 추가)'}
};
...
function conditionSearchCard(result){
  const groups=(Array.isArray(result?.refinement_chips)?result.refinement_chips:[]).filter(group=>group?.label&&group?.values?.length);
  if(!groups.length)return null;
  const copy=conditionSearchCopy[elements.language.value]||conditionSearchCopy.JA;
  const selected=new Map();
  const card=document.createElement('article');
  card.className='refinement-card condition-search-card';
...
function marketplaceFallbackGroup(label,linksNode){if(!linksNode)return null;const group=document.createElement('div');group.className='marketplace-fallback-group';group.append(textElement('p','marketplace-fallback-group-label',label),linksNode);return group;}
function marketplaceFallbackCard(result){if(!result?.marketplace_search_links?.length&&!result?.amazon_search_url)return null;const labels={JA:['10モールとSNSを横断して探す','Amazon・楽天市場・Yahoo!ショッピング・Qoo10・SHEIN・ZOZOTOWN・SHOPLIST・MUSINSA・BUYMA・SNKRDUNKと、Instagram・X・TikTok・YouTubeで探せます。','モールで探す','SNSで探す'],EN:['Search ten marketplaces and social platforms','Search ten marketplaces plus Instagram, X, TikTok, and YouTube with the same terms.','Marketplaces','Social search'],ZH:['跨十个商城和社交平台查找','可在十个商城以及 Instagram、X、TikTok 和 YouTube 继续搜索。','商城','社交平台'],KO:['10개 쇼핑몰과 SNS에서 함께 찾기','10개 쇼핑몰과 Instagram, X, TikTok, YouTube에서 같은 조건으로 찾을 수 있습니다.','쇼핑몰','SNS']};const [label,body,mallLabel,socialLabel]=labels[elements.language.value]||labels.JA;const actions=actionCopy[elements.language.value]||actionCopy.JA;const language=elements.language.value;const card=document.createElement('article');card.className='refinement-card marketplace-fallback';card.id='marketplaceFallback';const intro=document.createElement('div');intro.className='marketplace-fallback-intro';intro.append(textElement('strong','',label),textElement('p','',body));const analysis=result?.ai_discovery?.analysis||null;const intentBlock=aiIntentSummaryBlock(analysis,language);if(intentBlock)intro.append(intentBlock);const candidateCards=aiCandidateCards(analysis?.product_candidates,language);if(candidateCards)intro.append(candidateCards);const keywords=String(elements.query.value||result?.search_keywords||result?.amazon_search_keywords||'');const tagSource=analysis?.search_keywords?.length?analysis.search_keywords.join(' '):keywords;const tagBlock=keywordTagBlock(tagSource,actions,(aiIntentLabels[language]||aiIntentLabels.JA).keywords);if(tagBlock)intro.append(tagBlock);card.append(intro);const legacy=result.amazon_search_url?[{marketplace:'AMAZON_JP',label:'Amazonで探す',url:result.amazon_search_url}]:[];const mallGroup=marketplaceFallbackGroup(mallLabel,marketplaceLinks(result.marketplace_search_links?.length?result.marketplace_search_links:legacy));if(mallGroup)card.append(mallGroup);const socialLinks=marketplaceLinks(socialDiscoverySearchLinks(keywords));if(socialLinks){socialLinks.classList.add('social-search-links');const socialGroup=marketplaceFallbackGroup(socialLabel,socialLinks);if(socialGroup)card.append(socialGroup);}return card;}
function aiDiscoveryCard(result){const items=(result?.ai_discovery?.candidates||[]).filter(item=>item?.url&&item?.image).slice(0,3);if(!items.length)return null;const labels={JA:['AIが見つけた可能性のある商品','10モールで確認できなかったため、公開Webから近い候補を探しました。未確認候補のため、商品ページで内容を確認してください。','候補ページを見る'],EN:['Possible products found by AI','The ten marketplaces had no confirmed match, so AI searched the public web. These are unconfirmed leads; verify the product page.','View candidate page'],ZH:['AI找到的可能商品','十个商城均无确认结果，因此AI搜索了公开网页。这些是未确认候选，请在商品页核实。','查看候选页面'],KO:['AI가 찾은 가능성 있는 상품','10개 쇼핑몰에서 확인되지 않아 공개 웹에서 비슷한 후보를 찾았습니다. 미확인 후보이므로 상품 페이지에서 확인하세요.','후보 페이지 보기']}[elements.language.value]||null;const card=document.createElement('article');card.className='ai-discovery-card';card.append(textElement('span','ai-discovery-badge','AI DISCOVERY'),textElement('h3','',labels[0]),textElement('p','ai-discovery-notice',labels[1]));const list=document.createElement('div');list.className='ai-discovery-list';items.forEach(item=>{const link=document.createElement('a');link.className='ai-discovery-item';link.href=item.url;link.target='_blank';link.rel='noopener noreferrer';const image=document.createElement('img');image.src=item.image;image.alt='';image.loading='lazy';image.referrerPolicy='no-referrer';link.append(image,textElement('strong','',item.title),textElement('small','',item.source||''),textElement('span','',labels[2]));list.append(link);});card.append(list);return card;}function renderResults(result,requestId){const t=selectedCopy();elements.results.classList.remove('hidden');elements.message.textContent=result.message||'';const candidates=(result.candidates||[]).slice(0,30);console.info('SEARCH_TRACE_CLIENT',{requestId,stage:'11_ui_render',ui_render_count:candidates.length});const cards=candidates.map((candidate,index)=>{const card=document.createElement('article');card.className='product-card';const safeRank=Math.max(1,Number(candidate.rank)||index+1);card.append(textElement('span','rank',`NO. ${safeRank}`));if(candidate.image){const image=document.createElement('img');image.className='product-image';image.src=candidate.image;image.alt='';image.loading='lazy';image.referrerPolicy='no-referrer';card.append(image);}card.append(textElement('h3','',candidate.display_name||candidate.product_name||candidate.asin));if(candidate.description)card.append(textElement('p','',candidate.description));const terms=candidate.evidence?.matched_terms||[];if(terms.length)card.append(textElement('div','evidence',`${window.HoshiluI18n?.t('search.evidence',elements.language.value)||'一致した手がかり：'}${terms.slice(0,4).join(' / ')}`));const options=renderOfferOptions(candidate,t,elements.language.value);if(options)card.append(options);else card.append(allMarketplacesButton());const watch=createWatchOptions(t);card.append(watch.bell,watch.dialog);return card;});if(cards.length){const carousel=document.createElement('div');carousel.className='result-carousel';const track=document.createElement('div');track.className='result-track';track.append(...cards);carousel.append(track);if(cards.length>3){const previous=document.createElement('button');previous.type='button';previous.className='carousel-button previous';previous.setAttribute('aria-label','前の商品を見る');previous.textContent='‹';const next=document.createElement('button');next.type='button';next.className='carousel-button next';next.setAttribute('aria-label','次の商品を見る');next.textContent='›';const move=direction=>track.scrollBy({left:direction*track.clientWidth,behavior:'smooth'});previous.addEventListener('click',()=>move(-1));next.addEventListener('click',()=>move(1));carousel.append(previous,next);}const resultCards=[];const clarification=clarificationCard(result);if(clarification)resultCards.push(clarification);resultCards.push(carousel);const relatedKeywords=relatedKeywordCard(result);if(relatedKeywords)resultCards.push(relatedKeywords);const conditionSearch=conditionSearchCard(result);if(conditionSearch)resultCards.push(conditionSearch);resultCards.push(refinementCard());const marketplaceFallback=marketplaceFallbackCard(result);if(marketplaceFallback)resultCards.push(marketplaceFallback);elements.cards.replaceChildren(...resultCards);}else{const emptyCards=[];const clarification=clarificationCard(result);if(clarification)emptyCards.push(clarification);const empty=document.createElement('article');empty.className='empty-result';empty.append(textElement('p','',elements.query.value));const wish=document.createElement('button');wish.type='button';wish.className='wish-button';wish.textContent=t.wish;wish.addEventListener('click',()=>{saveWish(elements.query.value);wish.textContent=t.wishSaved;wish.disabled=true;});empty.append(wish);emptyCards.push(empty);const emptyRelatedKeywords=relatedKeywordCard(result);if(emptyRelatedKeywords)emptyCards.push(emptyRelatedKeywords);const emptyConditionSearch=conditionSearchCard(result);if(emptyConditionSearch)emptyCards.push(emptyConditionSearch);const aiCard=aiDiscoveryCard(result);if(aiCard)emptyCards.push(aiCard);const marketplaceFallback=marketplaceFallbackCard(result);if(marketplaceFallback)emptyCards.push(marketplaceFallback);elements.cards.replaceChildren(...emptyCards);}elements.results.scrollIntoView({behavior:'smooth',block:'start'});}async function initializeTurnstile(){ const response=await fetch('/api/config',{cache:'no-store'});if(!response.ok)throw new Error('TURNSTILE_NOT_CONFIGURED');const config=await response.json();for(let i=0;i<100&&!window.turnstile;i+=1)await new Promise(resolve=>setTimeout(resolve,50));if(!window.turnstile)throw new Error('TURNSTILE_UNAVAILABLE');turnstileWidget=window.turnstile.render(elements.turnstile,{sitekey:config.turnstile_site_key,theme:'light',size:'flexible'}); }

const notificationUiCopy={JA:{title:'AIウォッチ通知',refresh:'更新',login:'無料会員でログインすると通知を確認できます。',empty:'通知はまだありません。',read:'既読にする',dismiss:'非表示',testSeed:'テスト通知を4件表示',testClear:'テスト通知を削除'},EN:{title:'AI Watch alerts',refresh:'Refresh',login:'Sign in as a free member to see alerts.',empty:'No notifications yet.',read:'Mark read',dismiss:'Dismiss',testSeed:'Show 4 test notifications',testClear:'Delete test notifications'},ZH:{title:'AI监控提醒',refresh:'更新',login:'登录免费会员后即可查看提醒。',empty:'暂无提醒。',read:'标为已读',dismiss:'隐藏',testSeed:'显示4条测试通知',testClear:'删除测试通知'},KO:{title:'AI 워치 알림',refresh:'새로고침',login:'무료 회원으로 로그인하면 알림을 확인할 수 있습니다.',empty:'아직 알림이 없습니다.',read:'읽음',dismiss:'숨기기',testSeed:'테스트 알림 4건 표시',testClear:'테스트 알림 삭제'}};
// RC2 verification-only: set from /api/config's mywatch_test_events_enabled
// (see mywatch-routes.mjs's test-seed route). Stays false, and the controls
// stay hidden, unless an operator explicitly turns the flag on.
let mywatchTestEventsEnabled=false;
async function seedMywatchTestNotifications(){const response=await fetch('/api/member/notifications/test-seed',{method:'POST'});if(response.ok)await loadNotifications();return response.ok;}
async function clearMywatchTestNotifications(){const response=await fetch('/api/member/notifications/test-seed',{method:'DELETE'});if(response.ok)await loadNotifications();return response.ok;}
function renderMywatchTestControls(){const host=document.querySelector('#mywatchTestControls');if(!host)return;if(!mywatchTestEventsEnabled||!memberSession){host.classList.add('hidden');host.replaceChildren();return;}const ui=notificationUiCopy[elements.language.value]||notificationUiCopy.JA;host.classList.remove('hidden');const seed=document.createElement('button');seed.type='button';seed.className='mywatch-test-button';seed.textContent=ui.testSeed;seed.addEventListener('click',()=>seedMywatchTestNotifications());const clear=document.createElement('button');clear.type='button';clear.className='mywatch-test-button';clear.textContent=ui.testClear;clear.addEventListener('click',()=>clearMywatchTestNotifications());host.replaceChildren(seed,clear);}
async function initializeMywatchTestControls(){try{const response=await fetch('/api/config',{cache:'no-store'});if(!response.ok)return;mywatchTestEventsEnabled=Boolean((await response.json()).mywatch_test_events_enabled);}catch{mywatchTestEventsEnabled=false;}renderMywatchTestControls();}
...
elements.goSearch.addEventListener('click',focusSearch);
elements.goWish.addEventListener('click',()=>document.querySelector('#insight').scrollIntoView({behavior:'smooth',block:'start'}));
...
async function waitForTurnstileToken(){for(let attempt=0;attempt<100;attempt+=1){const token=window.turnstile?.getResponse(turnstileWidget)||'';if(token)return token;if(attempt===0&&turnstileWidget!==null)window.turnstile?.reset(turnstileWidget);await new Promise(resolve=>setTimeout(resolve,100));}return '';}
...
// finally block), so waitForTurnstileToken's reuse-if-present behavior is
// safe there. HOSHILU AI Chat calls this once per chat turn (potentially
// several times in one dialog session without an intervening main-search
// reset), so reusing whatever token happens to still be cached would send
// an already-consumed token on the 2nd+ turn and fail server-side
// verification ("通信に失敗しました" - reproduced and confirmed via the
// real production chat). Always reset first so every call gets a fresh one.
async function waitForFreshTurnstileToken(){if(turnstileWidget!==null)window.turnstile?.reset(turnstileWidget);for(let attempt=0;attempt<100;attempt+=1){const token=window.turnstile?.getResponse(turnstileWidget)||'';if(token)return token;await new Promise(resolve=>setTimeout(resolve,100));}return '';}
...
elements.language.addEventListener('change',()=>{setLanguage(elements.language.value);renderMemberState();renderNotifications();});
