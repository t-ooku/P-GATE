...
const navigationCopy = {
  JA:{eyebrow:'名前が分からなくても探せます。',features:['ホシル検索','購入希望価格ウォッチ'],account:'マイページ',candidateAmazon:'Amazonでこの商品を探す'},
  EN:{eyebrow:'You can search without knowing the name.',features:['HOSHILU Search','Target price watch'],account:'My page',candidateAmazon:'Find this product on Amazon'},
  ZH:{eyebrow:'不知道名字也能搜。',features:['HOSHILU 搜索','目标价监控'],account:'我的页面',candidateAmazon:'在 Amazon 查找此商品'},
  KO:{eyebrow:'이름을 몰라도 찾을 수 있어요.',features:['HOSHILU 검색','목표 가격 감시'],account:'마이페이지',candidateAmazon:'Amazon에서 이 상품 찾기'}
};
...
function createWatchOptions(candidate,t){
  ...
  const watchButtonCopy={JA:'購入希望価格ウォッチ☑',EN:'Target price watch ✓',ZH:'目标价监控☑',KO:'목표 가격 감시☑'};
