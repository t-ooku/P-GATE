...
Object.assign(searchInputCopy.JA,{socialActionClose:'投稿URLを削除',actionsLabel:'検索の手がかりを追加',queryLabel:'欲しいものについて話す',previewAlt:'追加した画像のプレビュー',preparing:'画像を準備しています。少し待ってからもう一度押してください。',heroPromise:'AIは手がかりを理解し、HOSHILUは実際の購入先を探す。見つけた商品ページやショップモールの検索ページへ案内します。'});
