const COPY = {
  ...
  KO: {
    ...
    lead: '카테고리와 상관없이 항상 최대 10개 쇼핑몰을 함께 찾습니다.',
    count: '최대 10개 쇼핑몰',
    core: '모든 카테고리',
    coreAria: '주요 5개 쇼핑몰',
    fashion: '패션',
    fashionAria: '패션 5개 쇼핑몰',
...
export function applyMarketplaceCoverage(language = selectedLanguage()) {
  ...
  if (language === 'JA') {
    ...
    responsiveCopy(nodes.lead, ['ジャンルを問わず、', '常に最大10モールを横断して探します。']);
  } else {
