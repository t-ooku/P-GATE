const CACHE = 'hoshilu-shell-v398';
const SHELL = ['/', '/privacy.html', '/terms.html', '/styles.css', '/wish-carousel.css', '/mywatch.css', '/hero-fixes.css', '/hero-slides.css', '/hero-slides.mjs', '/hoshilu-fashion-collage-v1.png', '/hoshilu-electronics-collage-v1.png', '/lp-layout.mjs', '/marketplace-coverage.css', '/marketplace-coverage.mjs', '/sale-center.css', '/sale-center.mjs', '/hero-collage-overlay.css', '/hero-collage-overlay.mjs', '/discovery.css', '/hoshilu-discovery-collage.webp', '/hoshilu-discovery-collage-mobile.webp', '/sticky-nav.css', '/speech-input.css', '/speech-input.js', '/social-share-targets.js', '/install.css', '/app.js', '/assets-v140/app.js', '/ranking-confirmation-flow.mjs', '/growth-analytics.mjs', '/campaign-attribution.mjs', '/wish-localization.mjs', '/marketplace-search-keywords-v2.mjs', '/manifest-v2.webmanifest', '/og-hoshilu.png', '/icons/icon.svg', '/icons/hoshilu-v2-180.png', '/icons/hoshilu-v2-192.png', '/icons/hoshilu-v2-512.png', '/auth.css', '/site-i18n.js', '/member-login.js', '/login.html', '/seller-login.html', '/seller-login.js'];
