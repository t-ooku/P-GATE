const CACHE = 'hoshilu-shell-v396';
const SHELL = ['/', '/privacy.html', '/terms.html', '/styles.css', '/wish-carousel.css', '/mywatch.css', '/hero-fixes.css', '/hero-slides.css', '/hero-slides.mjs', '/hoshilu-fashion-collage-v1.png', '/hoshilu-electronics-collage-v1.png', '/lp-layout.mjs', '/marketplace-coverage.css', '/marketplace-coverage.mjs', '/sale-center.css', '/sale-center.mjs', '/hero-collage-overlay.css', '/hero-collage-overlay.mjs', '/discovery.css', '/hoshilu-discovery-collage.webp', '/hoshilu-discovery-collage-mobile.webp', '/sticky-nav.css', '/speech-input.css', '/speech-input.js', '/social-share-targets.js', '/install.css', '/app.js', '/assets-v138/app.js', '/ranking-confirmation-flow.mjs', '/growth-analytics.mjs', '/campaign-attribution.mjs', '/wish-localization.mjs', '/marketplace-search-keywords-v2.mjs', '/manifest-v2.webmanifest', '/og-hoshilu.png', '/icons/icon.svg', '/icons/hoshilu-v2-180.png', '/icons/hoshilu-v2-192.png', '/icons/hoshilu-v2-512.png', '/auth.css', '/site-i18n.js', '/member-login.js', '/login.html', '/seller-login.html', '/seller-login.js'];

SHELL.push('/result-rows.mjs', '/discovery-actions.mjs', '/vertical-ticker.mjs', '/search-failure-telemetry.mjs', '/growth-marketplaces.mjs', '/ai-search-ui.mjs', '/ai-search-ui.css', '/ai-search-layout-fix.css', '/assets-v125/ai-search-layout-fix.css', '/layout-v3.css', '/announcements.mjs', '/hero-marketplace-coverage.mjs', '/ai-price-comparison-ui.mjs', '/ai-price-comparison-ui.css');
