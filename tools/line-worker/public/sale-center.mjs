const copy = {
  JA:{title:'セールだけ、先回りして届く。',lead:'掲載10モールの確認済みセール情報を横断。開始前にもお知らせし、始まったらホシルで本当に安い購入先を探せます。',notice:'無料会員限定・セール専用通知',noticeBody:'おすすめ記事や一般ニュースは通知しません。割引セールの開始前と開始時だけをお知らせします。',toggle:'全モールのセール通知を受け取る',login:'ログインすると設定を保存できます。',empty:'確認済みのセール情報を準備中です。未確認情報は掲載しません。',starts:'開始',ends:'終了',updated:'更新',detail:'公式情報を見る',saved:'セール通知だけを受け取る設定を保存しました。',off:'セール通知を停止しました。'},
  ...
  ZH:{title:'只推送促销，并提前通知。',lead:'汇总十个商城的已确认促销。开售前提醒，开始后可在 HOSHILU 比较真正的最低价。',notice:'免费会员专享・仅促销通知',noticeBody:'不推送一般资讯或推荐，只在已确认促销开始前和开始时通知。',toggle:'接收所有商城的促销通知',login:'登录后可保存此设置。',empty:'正在准备已验证的促销信息。未经确认的信息不会发布。',starts:'开始',ends:'结束',updated:'更新',detail:'查看官方信息',saved:'已开启仅促销通知。',off:'已关闭促销通知。'},
