...
// atomic rollout path /assets-v143/app.js. Relative specifiers from the latter
// would incorrectly resolve to /assets-v143/*.mjs and stop the whole UI.
  ...
  try{
    ...
    for(let attempt=0;attempt<maxAttempts;attempt+=1){
      try{
        ...
        const requestTimeoutMs=hasSupplementalInput?30000:KNOWLEDGE_HTTP_TIMEOUT_MS;
