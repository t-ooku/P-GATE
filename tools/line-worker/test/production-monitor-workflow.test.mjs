...
test('monitor heartbeat is original-schedule-only and persisted incidents are acknowledged after reconciliation', () => {
  ...
  assert.match(workflow, /steps\.incident\.outcome == 'success'/u);
