...
Query StructurerまたはAIチャット主系の失敗は1回で検知する。全componentについて、設定・認証・
モデル・価格表・予算・usageの異常も1回で検知し、それ以外の非主系の一時失敗だけは異なる2回の
連続失敗で検知する。初回配備の欠測猶予は2026-08-13 10:30 UTCまでに限定し、同時刻以降に
