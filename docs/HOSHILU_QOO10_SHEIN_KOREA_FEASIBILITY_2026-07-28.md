...
- 若者が共有・投票・ほしっトクし、トレンドが検索・保存データとして蓄積される。
...
若者向けの成長導線は、韓国トレンド特集、短尺動画・Creator投稿、形状＋機能検索、投票、ほしっトク、価格・入荷通知、共有カードを一つのループにする。報酬率ではなく記憶との一致と信頼性をランキングの主軸にする。
...
- 検索、ほしっトク、共有、送客、購入確認をevent化し、個人情報を分離した集計基盤で韓国トレンドを検出する。
