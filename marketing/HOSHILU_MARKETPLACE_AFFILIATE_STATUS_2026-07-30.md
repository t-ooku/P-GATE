...
| ZOZOTOWN | アパレル検索へ接続準備 | 未接続 | 公開公式ページでは確認できず | ASP管理画面またはZOZOへ提携可否を照会 |
| SHOPLIST | アパレル検索へ接続準備 | 未接続 | 公開公式ページでは確認できず | ASP管理画面またはSHOPLISTへ提携可否を照会 |
| MUSINSA | アパレル検索へ接続準備 | 未接続 | 公式「MUSINSA Curator」あり | 日本向けサイト・HOSHILU Web媒体が対象か確認 |
| BUYMA | アパレル検索へ接続準備 | 未接続 | 公開公式ページでは確証不足 | BUYMAまたはASPへメディア提携を照会 |
